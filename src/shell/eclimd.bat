...
start "eclimd" "%ECLIPSE_HOME%\eclipse" -debug -consolelog -nosplash -refresh -application org.eclim.application -vmargs -Declim.home="%ECLIPSE_HOME%" -Dorg.eclim.spring-factory.xml=org/eclim/spring-factory-server.xml
goto exit
