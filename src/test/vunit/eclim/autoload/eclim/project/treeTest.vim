...
function! TestProjectTreeMultiple()
  ...
  call VUAssertEquals(getline( 7), '    test_root_file.txt')
  call VUAssertEquals(getline( 8), 'eclim_unit_test_java/')
  call VUAssertEquals(getline( 9), '  + doc/')
  call VUAssertEquals(getline(10), '  + log4j/')
  call VUAssertEquals(getline(11), '  + src/')
  call VUAssertEquals(getline(12), '  + webxml/')
  ...
  call VUAssertEquals(getline(16), 'eclim_unit_test_web/')

  normal 8j
  call VUAssertEquals(line('.'), 16)
  call VUAssertEquals(col('.'), 1)
  ...
  call VUAssertEquals(getline(15), '    pom.xml')
  call VUAssertEquals(getline(16), 'eclim_unit_test_web/')
  call VUAssertEquals(getline(17), '  + css/')
  call VUAssertEquals(getline(18), '  + dtd/')
endfunction " }}}
