...
function! TestProjectTree()
  ...
  call vunit#AssertEquals(getline(6), '    test_archive.tar.gz')
  call vunit#AssertEquals(getline(7), '    test_root_file.txt')
  ...
  call vunit#AssertEquals(getline( 9), '    test_archive.tar.gz')
  call vunit#AssertEquals(getline(10), '    test_root_file.txt')
...
function! TestProjectTreeMultiple()
  ...
  call vunit#AssertEquals(getline(6), '    test_archive.tar.gz')
  call vunit#AssertEquals(getline(7), '    test_root_file.txt')
  call vunit#AssertEquals(getline(8), 'eclim_unit_test_java/')
  call vunit#AssertEquals(getline(9), 'eclim_unit_test_web/')
  ...
  call vunit#AssertEquals(getline( 7), '    test_root_file.txt')
  call vunit#AssertEquals(getline( 8), 'eclim_unit_test_java/')
  call vunit#AssertEquals(getline( 9), '  + bin/')
  call vunit#AssertEquals(getline(10), '  + doc/')
  call vunit#AssertEquals(getline(11), '  + log4j/')
  call vunit#AssertEquals(getline(12), '  + src/')
  call vunit#AssertEquals(getline(13), '  + src-javac/')
  call vunit#AssertEquals(getline(14), '  + src-linked -> ' . workspace . 'eclim_unit_test_java_linked/src/')
  call vunit#AssertEquals(getline(15), '  + webxml/')
  call vunit#AssertEquals(getline(16), '  + zlink -> ' . workspace . 'eclim_unit_test_java_linked/other/')
  call vunit#AssertEquals(getline(17), '    build.xml')
  call vunit#AssertEquals(getline(18), '    checkstyle.xml')
  call vunit#AssertEquals(getline(19), '    pom.xml')
  call vunit#AssertEquals(getline(20), 'eclim_unit_test_web/')

  normal 12j
  call vunit#AssertEquals(line('.'), 20)
  call vunit#AssertEquals(col('.'), 1)
  ...
  call vunit#AssertEquals(getline(19), '    pom.xml')
  call vunit#AssertEquals(getline(20), 'eclim_unit_test_web/')
  call vunit#AssertEquals(getline(21), '  + css/')
  call vunit#AssertEquals(getline(22), '  + dtd/')
endfunction " }}}
