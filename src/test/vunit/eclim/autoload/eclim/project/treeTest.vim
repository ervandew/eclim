...
function! TestProjectTreeMultiple()
  ...
  call VUAssertEquals(getline( 7), '    test_root_file.txt')
  call VUAssertEquals(getline( 8), 'eclim_unit_test_java/')
  call VUAssertEquals(getline( 9), '  + log4j/')
  call VUAssertEquals(getline(10), '  + src/')
  call VUAssertEquals(getline(11), '  + webxml/')
  ...
  call VUAssertEquals(getline(15), 'eclim_unit_test_web/')

  normal 7j
  call VUAssertEquals(line('.'), 15)
  call VUAssertEquals(col('.'), 1)
  ...
  call VUAssertEquals(getline(14), '    pom.xml')
  call VUAssertEquals(getline(15), 'eclim_unit_test_web/')
  call VUAssertEquals(getline(16), '  + css/')
  call VUAssertEquals(getline(17), '  + dtd/')
endfunction " }}}
