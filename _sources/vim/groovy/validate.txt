...
When saving a groovy source file that resides in a project, eclim will update
...
**g:EclimGroovyValidate** variable (described below). If you choose to disable
...
.. _g\:EclimGroovyValidate:

- **g:EclimGroovyValidate** (Default: 1) -
