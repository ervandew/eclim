...
function! TestCallHierarchyCallers() " {{{
...
function! TestCallHierarchyCallees() " {{{
  edit! src/callhierarchy/mod2.c
  call vunit#PeekRedir()
  ...
  let name = substitute(expand('%'), '\', '/', 'g')
  call vunit#AssertEquals('src/callhierarchy/mod2.c', name, 'Wrong window (mod2.c)')
  call vunit#AssertEquals(8, line('.'), 'Wrong line (mod2.c')
  ...
  call vunit#AssertEquals(5, line('.'), 'Wrong line (mod1.c')
  call vunit#AssertEquals(10, col('.'), 'Wrong column (mod1.c')
endfunction " }}}
